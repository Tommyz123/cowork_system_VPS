...
- [2026-06-12, 深度审核挂起] **discord_approve 授权词变体增补** | 背景:"可以加,但是…"未触发授权(6/11实锤),候选增补"可以加/加吧/可以做" | 缓做原因:授权词改动敏感,且近期刚因"那可以"误触发踩坑,不宜随便加变体 | 触发:系统复盘时统一评估授权词词库(防从句误触发原则见 feedback_discord_approve_design)
