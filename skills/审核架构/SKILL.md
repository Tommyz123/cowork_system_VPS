...
核心文件是否存在：
```bash
ls /root/cowork/{CLAUDE.md,ARCHITECTURE.md,context.md,CURRENT_SESSION.md,BACKLOG.md,INSIGHTS.md,friction_log.md,cowork_log.md,reference/knowledge_base.md}
```
...
ls /root/cowork/memory/ | wc -l
cat /root/cowork/memory/auto_pending.md
```
...
```bash
grep -c "⚠️" /root/cowork/friction_log.md
```
