...
> 来源：https://github.com/anthropics/knowledge-work-plugins/tree/main/bio-research
> 性质：**纯参考方法论**，未安装/未配置。用得上时手动借鉴其 skill 的套路与输出模板。
> 与主公业务相关度：低 — 生命科学R&D（无关）

**官方连接器(MCP)**：pubmed, biorender, biorxiv, consensus, c-trials, chembl, synapse, wiley, owkin, ot, benchling
